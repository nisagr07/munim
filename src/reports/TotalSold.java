...
public class TotalSold extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String comboValue = String.valueOf(jComboBox2.getSelectedItem());
        ...
        if(jXDatePicker1.getDate()==null || jXDatePicker2.getDate() == null){
            JOptionPane.showMessageDialog(null,"Please enter valid date ","Total Sold",JOptionPane.PLAIN_MESSAGE);
            return;
        }
        ...
        if(fromDate>toDate){
            JOptionPane.showMessageDialog(null,"From-Date cannot be greater than To-Date ","Total Sold",JOptionPane.PLAIN_MESSAGE);
            return;
        }
        ...
        if(rowList == null){
            JOptionPane.showMessageDialog(null,"No Stock Sold","Total Sold",JOptionPane.PLAIN_MESSAGE);
            return;
        }
        if(rowList!=null && rowList.size()==1){
            JOptionPane.showMessageDialog(null,"No Stock sold between this period","Total Sold",JOptionPane.PLAIN_MESSAGE);
            return;
        }
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        if(comboValue.equalsIgnoreCase("Date")){
            ...
            if(jComboBox1.getItemCount()==0){
                JOptionPane.showMessageDialog(null,"There are no FOS","Total Sold",JOptionPane.PLAIN_MESSAGE);
                jComboBox2.setSelectedItem("Date");
            }
            else {
    ...
    private void jXDatePicker1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXDatePicker1ActionPerformed
        ...
        if(diff > 60){
            JOptionPane.showMessageDialog(null,"You can't select date older than 60 days","Total Sold",JOptionPane.PLAIN_MESSAGE);
